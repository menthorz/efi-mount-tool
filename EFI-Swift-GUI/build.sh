...
<dict>
    ...
    <string>This app needs to execute administrative commands to mount/unmount EFI partitions.</string>
    <key>NSPrivacyAccessibilityUsageDescription</key>
    <string>This app needs accessibility access to manage EFI partitions with administrator privileges.</string>
    <key>CFBundleDocumentTypes</key>
    <array>
        <dict>
            <key>CFBundleTypeName</key>
            <string>EFI Partition</string>
